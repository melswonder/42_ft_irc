...
void Server::handleKick(Client* client, const std::vector<std::string> &data) {
    // 1. パラメータのチェック: ERR_NEEDMOREPARAMS (461)
    if (data.size() < 3) {
